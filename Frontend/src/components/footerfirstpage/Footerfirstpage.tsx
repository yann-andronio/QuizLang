    ...
    <Fragment>
      <footer className="bg-[#e0e5df] lg:h-screen md:h-screen w-full">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 items-center justify-center p-4">
          <div className="lang1 flex gap-2 justify-center items-center">
            <img
          ...
          <div className="lang2 flex gap-2 justify-center items-center">
            <img
          ...
          <div className="lang3 flex gap-2 justify-center items-center">
            <img
          ...
          <div className="lang4 flex gap-2 justify-center items-center">
            <img
