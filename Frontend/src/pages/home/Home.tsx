  ...
  return (
    <Fragment>
      <div className="parents relative bg-[#F8FAF5] flex h-screen ">
        <div
          className={` hidden  fixed top-0 left-0 min-h-screen  bg-[#F8FAF5]   lg:flex flex-col items-center p-5  border-r-2   `}
        >
        ...
        <div className={` hidden lg:block  fixed top-0 right-0 min-h-screen bg-[#F8FAF5]    p-8 w-[640px]  flex-1  `}>
          <Rigthhome />
        </div>
      </div>
    </Fragment>
